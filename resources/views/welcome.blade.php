...
<head>
    ...
    <title>Environmental Check Dashboard</title>
...
<body class="bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 text-gray-100">
    <!-- Navigation -->
    <nav class="border-b border-slate-700 bg-slate-800/50 backdrop-blur">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center h-16">
                ...
                <div class="flex items-center gap-4">
                    ...
                    @else
                        <a href="{{ route('login') }}"
                            class="px-4 py-2 rounded-lg text-gray-300 hover:text-white transition font-medium">
                            Login
                        </a>
    ...
    <main class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24">
        <div class="grid md:grid-cols-2 gap-12 items-center">
            <div>
                ...
                <p class="text-xl text-gray-300 mb-8">
                    Track and analyze your environmental check records in real-time. Upload Excel files, monitor
                    statistics, and visualize trends with powerful analytics.
                </p>
                <div class="flex gap-4">
                    ...
                    @else
                        ...
                        <a href="{{ route('register') }}"
                            class="px-8 py-3 bg-slate-700 text-white rounded-lg hover:bg-slate-600 transition font-semibold">
                            Get Started
                        </a>
                    @endauth
                </div>
            ...
            <div class="relative">
                <div
                    class="absolute inset-0 bg-gradient-to-r from-blue-500 to-cyan-500 rounded-2xl blur-3xl opacity-20">
                </div>
                <div class="relative bg-slate-800 rounded-2xl p-8 border border-slate-700">
                    <div class="space-y-4">
                        <div class="h-3 bg-gradient-to-r from-blue-500 to-cyan-500 rounded-full w-2/3"></div>
                        <div class="h-3 bg-slate-700 rounded-full w-full"></div>
                        <div class="h-3 bg-slate-700 rounded-full w-5/6"></div>
                    </div>
                    <div class="mt-8 grid grid-cols-2 gap-4">
                        ...
                        <div class="bg-slate-700/50 rounded-lg p-4 text-center">
                            <div class="text-2xl font-bold text-cyan-400">€45K</div>
        ...
        <div class="grid md:grid-cols-3 gap-8 mt-24">
            <div class="bg-slate-800/50 border border-slate-700 rounded-xl p-8 hover:border-blue-500 transition group">
                <div
                    class="w-14 h-14 bg-blue-600/20 rounded-lg flex items-center justify-center mb-4 group-hover:bg-blue-600/40 transition">
                    <svg class="w-8 h-8 text-blue-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            d="M12 19l9 2-9-18-9 18 9-2zm0 0v-8m0 8l-6-2m6 2l6-2"></path>
                    </svg>
                </div>
                <h3 class="text-lg font-semibold mb-2">Real-time Analytics</h3>
                <p class="text-gray-400">Monitor your environmental checks with live statistics and instant insights.
                </p>
            </div>

            <div class="bg-slate-800/50 border border-slate-700 rounded-xl p-8 hover:border-cyan-500 transition group">
                <div
                    class="w-14 h-14 bg-cyan-600/20 rounded-lg flex items-center justify-center mb-4 group-hover:bg-cyan-600/40 transition">
                    <svg class="w-8 h-8 text-cyan-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            d="M7 12l3-3 3 3 4-4M8 21l4-4 4 4M3 4h18M4 4h16v7a1 1 0 01-1 1H5a1 1 0 01-1-1V4z"></path>
                    </svg>
                </div>
                <h3 class="text-lg font-semibold mb-2">Excel Import</h3>
                <p class="text-gray-400">Easily upload Excel files with drag-and-drop. Automatic parsing and validation.
                </p>
            </div>

            <div
                class="bg-slate-800/50 border border-slate-700 rounded-xl p-8 hover:border-emerald-500 transition group">
                <div
                    class="w-14 h-14 bg-emerald-600/20 rounded-lg flex items-center justify-center mb-4 group-hover:bg-emerald-600/40 transition">
                ...
                <h3 class="text-lg font-semibold mb-2">Advanced Reports</h3>
                <p class="text-gray-400">Generate detailed reports with charts, trends, and comprehensive data insights.
                </p>
            </div>
        </div>
    </main>
    ...
    <!-- Footer -->
    <footer class="border-t border-slate-700 mt-24">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 text-center text-gray-400">
            <p>&copy; 2026 Environmental Check Dashboard. All rights reserved.</p>
        </div>
    </footer>
</body>
